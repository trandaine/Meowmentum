...
namespace EnglishApp.MVC.Areas.Identity.Pages.Account
{
    public class ConfirmEmailChangeModel : PageModel
    {
        ...
        public ConfirmEmailChangeModel(UserManager<EnglishAppIdentityUser> userManager, SignInManager<EnglishAppIdentityUser> signInManager)
        {
