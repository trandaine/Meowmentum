namespace EnglishApp.Infrastructure.Constants
{
    public static class ConnectionConstants
    {
        ...
        public const string SQL_SERVER_CONNECTION_STRING = "Server= ., 1433; Database=EnglishAppDb; User Id=sa; password=Dai@2018; TrustServerCertificate=True; Trusted_Connection=False; MultipleActiveResultSets=true;";
        ...
        public const string SQL_SERVER_IDENTITY_CONNECTION_STRING = "Server= ., 1433; Database=EnglishAppIdentityDb; User Id=sa; password=Dai@2018; TrustServerCertificate=True; Trusted_Connection=False; MultipleActiveResultSets=true;";
